...
#bgm
BGM = "C:/Users/찬주/Downloads/4_Snake_Game/MonoPoly - Turbo.mp3"
...
class Game(object):
    ...
    def run_logic(self):
        ...
        self.check_obs(self.snake, self.obstancle)
    ...
    def check_obs(self, snake, obstacle):
